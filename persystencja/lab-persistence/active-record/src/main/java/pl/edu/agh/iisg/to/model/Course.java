...
public class Course {
    ...
    public List<Student> studentList() {
        ...
        String findStudentListSql = "SELECT s.id, s.first_name, s.last_name, s.index_number, sc.course_id FROM student AS s JOIN student_course AS sc ON sc.student_id = s.id WHERE sc.course_id = ? ;";
        Object[] args = {
                this.id,
        };
